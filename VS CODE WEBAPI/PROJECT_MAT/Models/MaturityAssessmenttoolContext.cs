...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=MSI;Initial Catalog=MaturityAssessmenttool;Integrated Security=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Answers>(entity =>
            {
                entity.HasKey(e => e.AnswerId)
                    .HasName("PK__Answers__369373102A6F602E");
            ...
            modelBuilder.Entity<ProjectFunction>(entity =>
            {
                entity.HasKey(e => e.FunctionId)
                    .HasName("PK__ProjectF__5F1A56BDEBD4B807");
            ...
            modelBuilder.Entity<ProjectMembers>(entity =>
            {
                entity.HasKey(e => e.ProjectMemberId)
                    .HasName("PK__ProjectM__DC57FC71782A310C");
            ...
            modelBuilder.Entity<Questions>(entity =>
            {
                entity.HasKey(e => e.QuestionId)
                    .HasName("PK__Question__B0B3E0BE067A3B99");
                ...
                entity.HasOne(d => d.Function)
                    ...
                    .HasForeignKey(d => d.FunctionId)
                    .HasConstraintName("FK__Questions__Funct__31EC6D26");
            });
            ...
            modelBuilder.Entity<Survey>(entity =>
            {
                ...
                entity.HasOne(d => d.Project)
                    .WithMany(p => p.Survey)
                    .HasForeignKey(d => d.ProjectId)
                    .HasConstraintName("FK__Survey__Project___2F10007B");
            });
            ...
            modelBuilder.Entity<UserSurvey>(entity =>
            {
                ...
                entity.HasOne(d => d.Answer)
                    ...
                    .HasConstraintName("FK__UserSurve__Answe__38996AB5");

                entity.HasOne(d => d.Question)
                    .WithMany(p => p.UserSurvey)
                    .HasForeignKey(d => d.QuestionId)
                    .HasConstraintName("FK__UserSurve__Quest__37A5467C");

                entity.HasOne(d => d.Survey)
                    .WithMany(p => p.UserSurvey)
                    .HasForeignKey(d => d.SurveyId)
                    .HasConstraintName("FK__UserSurve__Surve__398D8EEE");
            });

            modelBuilder.Entity<Users>(entity =>
            {
                entity.HasKey(e => e.UserId)
                    .HasName("PK__users__B9BE370FE561F8A9");
